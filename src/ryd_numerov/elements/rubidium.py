...
class Rubidium87(Rubidium):
    species = "Rb87"

    _corrected_rydberg_constant = (109_736.623_016_046_65, None, "1/cm")


class Rubidium85(Rubidium):
    species = "Rb85"

    _corrected_rydberg_constant = (109_736.605, None, "1/cm")
