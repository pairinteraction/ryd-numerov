...
class Sodium(BaseElement):
    ...
    _quantum_defects: ClassVar = {
        (0, 0.5): (1.34796938, 0.0609892, 0.0196743, -0.001045, 0),  # [1,2]
        (1, 0.5): (0.85544502, 0.112067, 0.0479, 0.0457, 0),  # [2]
        (1, 1.5): (0.85462615, 0.112344, 0.0497, 0.0406, 0),  # [2]
        (2, 1.5): (0.014909286, -0.042506, 0.00840, 0, 0),  # [2,3]
        (2, 2.5): (0.01492422, -0.042585, 0.00840, 0, 0),  # [2,3]
        (3, 2.5): (0.001632977, -0.0069906, 0.00423, 0, 0),  # [3]
        (3, 3.5): (0.001630875, -0.0069824, 0.00352, 0, 0),  # [3]
        (4, 3.5): (0.00043825, -0.00283, 0, 0, 0),  # [3]
        (4, 4.5): (0.00043740, -0.00297, 0, 0, 0),  # [3]
        (5, 4.5): (0.00016114, -0.00185, 0, 0, 0),  # [3]
        (5, 5.5): (0.00015796, -0.00148, 0, 0, 0),  # [3]
    }
